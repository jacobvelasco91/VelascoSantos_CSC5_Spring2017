/* 
  ...
  Created on February 24, 2017, 12:30 PM
  Purpose:  Problem 17 - stock commission 
 */
...
int main(int argc, char** argv) {
    ...
    unsigned short stkPrce=35;  //Units of $'s/share
    ...
    //Output values
    cout<<"Stock Price/Share= $   "<<(stkPrce)<<"/share"<<endl;
